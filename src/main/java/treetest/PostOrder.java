...
public class PostOrder {
     ...
     *
     * 需要用last记录上次出栈的节点
     * 对于某个节点来说，上次出栈的节点，可能是左孩子，也可能是右孩子
     * 在判断的时候：
     * 如果last等于node的左孩子，则说明左孩子已经出栈打印了
     * 同理，如果last等于node的右孩子，说明右孩子已经出栈打印了，那么左孩子也打印过了
     *
     * 对于一个访问到的节点，可能是第一次访问到，需要入栈的。也可能是因为左孩子或者右孩子出栈之后又再次访问到的。
     * 所以，对左孩子和右孩子入栈的时候，需要进行判断。
     * 如果节点的左孩子不为空，并且上次出栈的节点不是左孩子，并且也不是右孩子，则左孩子可以入栈。
     * 如果节点的右孩子不为空，并且上次出栈的节点不是右孩子，则右孩子可以入栈。
     *
